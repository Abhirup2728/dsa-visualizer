...
import { bfsWithSteps } from "@/lib/algorithms/bfs";
import { sampleGraph } from "@/lib/graphs/sampleGraph";
import LearningPanel from "@/components/learning/LearningPanel";
import { bfsContent } from "@/content/topics";
...
export default function BFSPage() {
  ...
  const steps = useMemo(() => bfsWithSteps(sampleGraph, 0), []);
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-6 pt-4">
        <h1 className="text-xl font-semibold">Breadth-First Search (BFS)</h1>
      ...
      <LearningPanel content={bfsContent} />
    </div>
  );
}