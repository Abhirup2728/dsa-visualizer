...
import { linearSearchWithSteps } from "@/lib/algorithms/linearSearch";
import LearningPanel from "@/components/learning/LearningPanel";
import { linearSearchContent } from "@/content/topics";
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-6 pt-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold">Linear Search</h1>
      ...
      <LearningPanel content={linearSearchContent} />
    </div>
  );
}