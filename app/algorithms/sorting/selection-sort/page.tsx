...
import { selectionSortWithSteps } from "@/lib/algorithms/selectionSort";
import LearningPanel from "@/components/learning/LearningPanel";
import { selectionSortContent } from "@/content/topics";
...
export default function SelectionSortPage() {
  ...
  const steps = useMemo(
    () => selectionSortWithSteps(originalArray),
    [originalArray]
  );
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-6 pt-4">
        <h1 className="text-xl font-semibold">Selection Sort</h1>
      ...
      <LearningPanel content={selectionSortContent} />
    </div>
  );
}