...
import { mergeSortWithSteps } from "@/lib/algorithms/mergeSort";
import LearningPanel from "@/components/learning/LearningPanel";
import { mergeSortContent } from "@/content/topics";
...
export default function MergeSortPage() {
  ...
  const steps = useMemo(
    () => mergeSortWithSteps(originalArray),
    [originalArray]
  );
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-6 pt-4">
        <h1 className="text-xl font-semibold">Merge Sort</h1>
      ...
      <LearningPanel content={mergeSortContent} />
    </div>
  );
}