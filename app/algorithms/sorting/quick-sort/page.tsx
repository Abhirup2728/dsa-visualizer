...
import { quickSortWithSteps } from "@/lib/algorithms/quickSort";
import LearningPanel from "@/components/learning/LearningPanel";
import { quickSortContent } from "@/content/topics";
...
export default function QuickSortPage() {
  ...
  const steps = useMemo(
    () => quickSortWithSteps(originalArray),
    [originalArray]
  );
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <LearningPanel content={quickSortContent} />
    </div>
  );
}